...
test_that('inits are generated properly',{
  expect_true(is.null(get_inits(NULL, 1, 1)))
  expect_error(get_inits('test',1,1))

  func_inits <- function() list(a=1,b=2)
  expect_equal(get_inits(func_inits,3,1),
