context("Test densityplot generation")
...
test_that("densityplot errors in correct situations", {
...
test_that("Single-parameter densityplot works", {
...
test_that("Multi-parameter densityplot works", {
